...
//            List<RoleEntity> roles = (List<RoleEntity>) roleRepository.findAll();
//
//            List<RolePermissionMappingResponseDTO> rolePermissionDTOs = roles.stream()
//                    .map(role -> {
//                        RolePermissionMappingResponseDTO dto = new RolePermissionMappingResponseDTO();
//                        dto.setRoleId(role.getId());
//                        dto.setPermissionIds(role.getPermissionEntities().stream().map(PermissionEntity::getId).collect(Collectors.toList()));
//                        return dto;
//                    })
//                    .collect(Collectors.toList());
//
...
//        } catch (Exception e) {
//            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Failed to fetch all role permissions: " + e.getMessage());
//        }
//    }
//}
